        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                _ReportList(status: null, service: _firestoreService),
                _ReportList(status: 'pending', service: _firestoreService),
                _ReportList(status: 'in_progress', service: _firestoreService),
                _ReportList(status: 'completed', service: _firestoreService),
              ],
            ),
          ),
        ],
...
class _ReportList extends StatelessWidget {
  ...
  const _ReportList({required this.status, required this.service});
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _detailRow(
                              Icons.door_front_door, '호실', report.roomNumber),
                        ),
